...
function Projects({ image, title, text, stack, githubLink, liveLink}) {
  ...
  return (
    <Grid container  direction="row-reverse" className={classes.section} style={{alignContent:'center'}}>
        ...
        <Grid item xs={12} sm={6} className={classes.categoriesSection}>
          <div >
            ...
            <a href="https://indicov.co">
              <svg className="svg-links" width="33" height="32" viewBox="0 0 33 32" fill="none" style={{margin:'1rem 0.5rem 0rem'}} xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://indicov.co">
            <svg className="svg-links" width="32" height="32" style={{margin:'1rem 0.5rem 0rem'}} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
